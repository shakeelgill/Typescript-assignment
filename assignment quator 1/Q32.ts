...
//We define the current_users list
const current_users: string[] = ["touqeer", "ali", "usman", "adnan", "shakeel"];

//We define the new_users list
const new_users: string[] = ["Touqeer", "ALI", "amir", "Usman", "sajad"];
